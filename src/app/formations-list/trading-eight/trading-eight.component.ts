...
@Component({
  selector: 'app-trading-eight',
  templateUrl: './trading-eight.component.html',
  styleUrls: ['./trading-eight.component.scss']
})
export class TradingEightComponent implements OnInit {
  @Input() course!: Course;
