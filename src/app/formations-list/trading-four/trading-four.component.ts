...
@Component({
  selector: 'app-trading-four',
  templateUrl: './trading-four.component.html',
  styleUrls: ['./trading-four.component.scss']
})
export class TradingFourComponent implements OnInit {
  @Input() course!: Course;
